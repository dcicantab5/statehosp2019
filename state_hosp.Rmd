...
p <- plot_ly(data, x = ~spec_per_1000_adm, y = ~reorder(hospital, -spec_per_1000_adm), text = rownames(sthos), type = 'bar', 
             name = '',
...
p <- plot_ly(data, x = ~death_per_1000_adm, y = ~reorder(hospital, death_per_1000_adm), text = rownames(sthos), type = 'bar', 
             name = '',
            orientation = 'h', bar = list(color = "#150377", opacity = 0.93))
